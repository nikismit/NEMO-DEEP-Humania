...
Shader "NEMO/NEMO V_organ bush top"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float clampResult8 = clamp( ( (0.5 + (uv_TexCoord19.y - 0.0) * (1.0 - 0.5) / (1.0 - 0.0)) + ( ( _Breathvalue * -1.0 ) + 0.5 ) ) , -10.0 , 1.0 );
...
/*ASEBEGIN
Version=15600
684;420;1275;730;2218.245;-39.32591;1.233505;True;True
Node;AmplifyShaderEditor.RangedFloatNode;15;-1792.258,582.5304;Float;False;Constant;_Value2;Value 2;0;0;Create;True;0;0;False;0;-1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1791.858,513.0855;Float;False;Property;_Breathvalue;Breath value;3;0;Create;True;0;0;False;0;1;0.684;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;4;-638.5316,385.1498;Float;False;Property;_Glowcolor;Glow color;1;0;Create;True;0;0;False;0;1,0,0,0;1,0.6431373,0,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;5;-651.6028,619.7756;Float;False;Property;_Luminositygradient;Luminosity gradient;2;0;Create;True;0;0;False;0;0;11;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1;-511.4597,0.9147674;Float;False;Property;_Basecolor;Base color;0;0;Create;True;0;0;False;0;0,1,0,0;0,0.3793093,1,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=D0CDF2DCDD4B44C2DDEF8D32FE99E19935E922B8